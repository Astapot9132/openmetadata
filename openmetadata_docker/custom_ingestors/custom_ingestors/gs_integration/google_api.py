...
class BaseGoogleApi:
    ...
    """
    def __init__(self):
        self.token_path = os.environ['GS_TOKEN_PATH'] or './creds/token.json'
        self.SCOPES = [
    ...
    def _authorize(self):
        ...
        """
        flow = InstalledAppFlow.from_client_secrets_file(os.environ['GS_CREDENTIALS_PATH'] or './creds/credentials.json', self.SCOPES)
